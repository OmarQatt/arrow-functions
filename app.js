...
const sumInOneLiner = (num1, num2,num3,num4) => `${num1} + ${num2} + ${num3} + ${num4} = ${num1 + num2 + num3 + num4}`;
console.log('Sum as a one-liner:', sumInOneLiner(1,2,3,4,5));
...
console.log('Hello from the new object function', newObjectLit(['value1', 'value2', 'value3']));
...
console.log('Student',NewStudent(['value1', 'value2', 'value3']));
...
//this refer to Student object - joe object

// 2. What is "this" when joe.scopeArrow() is invoked?
// closest non-arrow parent function-the close one is window 
// as we know console.log(this) the value is window so this mean the window

// 3. Explain why "this" is different when an arrow function is used.
// arrow functions do not have their own this The value of this inside an arrow function 
// remains the same throughout the lifecycle of the function and is always bound to the value 
// of this in the losest non-arrow parent function.